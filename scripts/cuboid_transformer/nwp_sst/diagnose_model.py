...
Usage:
    python scripts/cuboid_transformer/nwp_sst/diagnose_model.py \
        ...
        --ckpt_name /home/gmm/zjj/gxy/Earthformer1/scripts/cuboid_transformer/nwp_sst/experiments/nwp_7day/checkpoints/model-epoch=035.ckpt \
...
def _build_model_from_cfg(cfg_path, device="cpu"):
    ...
    # Resolve attention patterns (consistent with cuboid_transformer.py __init__)
